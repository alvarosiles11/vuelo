...
public class TripulanteDtoTest {
	...
	public void CheckPropertiesValid() {
		...
		final TripulanteDto tripulanteDto = new TripulanteDto();
	...
	public void CheckConstructor() {
		...
		final TripulanteDto tripulanteDto = new TripulanteDto(keyTripulacion, keyTripulante, nombre, apellido, cargo,
				estado);
